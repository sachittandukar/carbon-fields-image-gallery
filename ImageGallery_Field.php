...
class Image_Gallery_Field extends Image_Field {
	...
	public function admin_init() {
		...
		$this->add_template( $this->get_type() . '-Description', [ $this, 'template_description' ] );
	}
	...
	public static function admin_enqueue_scripts() {
		...
		$dir = untrailingslashit( $url );

		# Enqueue JS
		wp_enqueue_script( 'carbon-field-ImageGallery', $dir . '/js/field.js', [ 'carbon-fields' ] );

		# Enqueue CSS
		wp_enqueue_style( 'carbon-field-ImageGallery', $dir . '/css/field.css' );
	}
}